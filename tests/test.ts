...
new TestGrammar(`syntaxes/sass.language.json`, null, run => {
  ...
  const _module = 'constant.character.module.imported';
  const moduleName = 'constant.character.module.imported.name';
  const moduleDot = 'constant.numeric.module.imported.dot';
